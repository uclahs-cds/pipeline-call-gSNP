...
include { calculate_sha512 } from './modules/validation.nf'
include { run_HaplotypeCallerVCF_GATK; run_HaplotypeCallerGVCF_GATK as run_HaplotypeCallerGVCF_GATK_normal; run_MergeVcfs_Picard as run_MergeVcfs_Picard_VCF; run_MergeVcfs_Picard as run_MergeVcfs_Picard_normal_GVCF } from './modules/genotype-processes.nf'
...
include { run_MergeSamFiles_Picard as run_MergeSamFiles_Picard_normal } from './modules/bam-processing.nf'
include { calculate_contamination_normal; run_DepthOfCoverage_GATK as run_DepthOfCoverage_GATK_normal } from './modules/summary-processes.nf'
